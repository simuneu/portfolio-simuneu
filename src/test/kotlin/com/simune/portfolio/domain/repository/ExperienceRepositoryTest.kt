...
import com.simune.portfolio.domain.entity.ExperienceDetail
...
class ExperienceRepositoryTest (
    ...
    fun beforeAll() {
        ...
        fun testFindAll() {
            ...
            println("findAll테스트 종료")
        }

        @Test
        fun testFindAllIsActive() {
            println("testFindAllIsActive 테스트 시작")
            ...
            println("testFindAllIsActive 테스트 종료")
        }
